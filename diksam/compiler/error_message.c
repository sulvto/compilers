...
ErrorDefinition dkc_error_message_format[] = {
		...
		{"PACKAGE_MEMBER_ACCESS_ERR $(member_name)"},
		...
		{"NON_VIRTUAL_METHOD_OVERRIDED_ERR $(name)"},
		{"NEED_OVERRIDE_ERR $(name)"},
		...
		{"FIELD_OVERRIDED_ERR"},
		{"ARRAY_METHOD_NOT_FOUND name: $(name)"},
        ...
        {"THROW_TYPE_IS_NOT_EXCEPTION_ERR class_name: $(class_name)"},
