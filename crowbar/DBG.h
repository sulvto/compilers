...
#ifndef CROWBAR_DBG_H
#define CROWBAR_DBG_H

typedef static DBG_Controller_tag *DBG_Controller;
...
#define DBG_assert(expression, arg) ((expression) ? (void)(0) : \
                                        ...
                                        DBG_assert_func arg))
#define DBG_panic(arg)              ((DBG_set(DBG_CURRENT_CONTROLLER, __FILE__, __LINE__)), \
                                        DBG_panic_func arg)
#define DBG_debug_write(arg)        ((DBG_set(DBG_CURRENT_CONTROLLER, __FILE__, __LINE__)), \
